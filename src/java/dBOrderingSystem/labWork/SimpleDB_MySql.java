...
public class SimpleDB_MySql {
	...
	public static void main(String[] args) {
		...
		SimpleDB_MySql db = new SimpleDB_MySql();
		...
		db.url = "jdbc:mysql://127.0.0.1:3306/menu_items";
...
//                                System.out.println("\nID: " + rs.getInt(1)); // column one (ResultSet field)
				System.out.println( "ID: " + rs.getObject(1) ); // named field
