package dBOrderingSystem.controller;
...
import dBOrderingSystem.model.*;
import java.util.List;
import javax.servlet.RequestDispatcher;

/**
 * This is the main controller for the Menu Item Selection App.
 * 
 * @author    Textbook, with modifications by Jim Lombardo
 * @version   1.00
 */
public class MenuItemSelectionController extends HttpServlet {
   private static final String RESULT_PAGE = "result.jsp";
    ...
    throws ServletException, IOException {
        ...
        String c = request.getParameter("itemName");
        
        // Create a new instance of a model object
        // For some applications, we would not want to create a new one each time.
        MenuItemReview be = new MenuItemReview();
